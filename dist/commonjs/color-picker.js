...
var CP = (function () {
	...
	CP.prototype.init = function init(opt) {
		opt = _jquery2['default'].extend({}, this.defaults, opt || {});
		...
		return _jquery2['default'].each(function () {
			if (!_jquery2['default'](this).data('colorpickerId')) {
				...
				_jquery2['default'](this).data('colorpickerId', id);
				var cal = _jquery2['default'](this.tpl).attr('id', id);
				if (options.flat) {
				...
				if (options.flat) {
					...
					_jquery2['default'](this).bind(options.eventName, this.show);
				}
			}
		});
	};
	...
	CP.prototype.hidePicker = function hidePicker() {
		return this.each(function () {
			if (_jquery2['default'](this).data('colorpickerId')) {
				_jquery2['default']('#' + _jquery2['default'](this).data('colorpickerId')).hide();
			}
		});
	};
